 ...
 */
@Component
@Named("org.xwiki.rest.internal.resources.attachments.AttachmentMetadataResourceImpl")
public class AttachmentMetadataResourceImpl extends XWikiResource implements AttachmentMetadataResource
{
    @Inject
        ...
        Boolean withPrettyNames) throws XWikiRestException
    {
        try {
            ...
            return this.modelFactory.toRestAttachment(this.uriInfo.getBaseUri(), xwikiAttachment, withPrettyNames,
                false);
